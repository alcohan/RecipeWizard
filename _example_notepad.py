...
headings = ['Id','Name','Unit','Yield','Weight','Cost','Calories','TTLFat','SatFat','Choles','Sodium','Carb','Fiber','Sugar','Protein']
data = db.query()
layout = [[sg.Menu(menu_layout)],
          [sg.Text('> New file <', font=('Consolas', 10), size=(WIN_W, 1), key='_INFO_')],
          [sg.Table(values=data, headings=headings, max_col_width=25, # background_color='lightblue',
